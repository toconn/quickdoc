...
class Test (unittest.TestCase):
    ...
    def test_calc_biweek_number_same_date(self):

        self._call_and_test_calc_biweek_number('2001-01-01', '2001-01-01', 1)

    def test_calc_biweek_number_end_of_week(self):

        self._call_and_test_calc_biweek_number('2001-01-01', '2001-01-14', 1)

    def test_calc_biweek_number_next_biweek(self):

        self._call_and_test_calc_biweek_number('2001-01-01', '2001-01-15', 2)

    def test_calc_biweek_number_next_biweek_2(self):

        self._call_and_test_calc_biweek_number('2001-01-01', '2001-01-28', 2)

    def test_calc_biweek_next_number_next_biweek(self):

        self._call_and_test_calc_biweek_next_number('2001-01-01', '2001-01-15', 3)

    def test_calc_week_number_same_date(self):

        self._call_and_test_calc_week_number('2001-01-01', '2001-01-01', 1)

    def test_calc_week_number_end_of_week(self):

        self._call_and_test_calc_week_number('2001-01-01', '2001-01-07', 1)
    ...
    def test_is_template_match_basic_match(self):
        
        self._call_and_test_is_template_file("qdoc.file.match", "qdoc.file", True)

    def test_is_template_match_basic_mismatch_no_extensions(self):
        
        self._call_and_test_is_template_file("qdoc.file", "qdoc.file", False)

    def test_is_template_match_basic_mismatch_qdef_extension(self):
        
        self._call_and_test_is_template_file ("qdoc.file." + QDOC_DEF_EXT, "qdoc.file", False)
    ...
    def _call_and_test_calc_biweek_number (self, start_date_string, end_date_string, expected):
        
        actual = self._qdoc._calc_biweek_number(start_date_string, end_date_string)
        self.assertEquals (expected, actual)

    def _call_and_test_calc_biweek_next_number (self, start_date_string, end_date_string, expected):
        
        actual = self._qdoc._calc_biweek_next_number(start_date_string, end_date_string)
        self.assertEquals (expected, actual)
    ...
    def _call_and_test_is_template_file (self, template_file_name, def_base_name, expected):
        
        actual = self._qdoc._is_template_file(template_file_name, def_base_name)
